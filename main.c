...
int main(int argc, char const *argv[])
{
    ...
    int cuenta_aux = 0;
    char *roles_temp[NUMERO_NODOS] = {"0c0r90a0p10x", "0c0r90a0p10x", "0c0r90a0p10x", "0c0r90a0p10x", "0c0r90a0p10x", "0c0r90a0p10x", "0c0r90a0p10x", "0c0r90a0p10x", "0c0r90a0p10x", "0c0r90a0p10x"};
    ...
    for (int i = 0; i < NUMERO_NODOS; i++)
    {
        if (pthread_create(&(tid_principales[i]), NULL, (void *)receptor, &(detalles_nodos[i])) != 0)
        {
            printf("Error al crear el hilo\n");
            exit(EXIT_FAILURE);
        }
